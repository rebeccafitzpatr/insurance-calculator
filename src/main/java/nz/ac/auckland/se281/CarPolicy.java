...
public class CarPolicy extends Policy {
  ...
  public CarPolicy(Profile profile, int sumInsured, String model, String licencePlate, Boolean mechanicalBreakdown) {
  ...
  public int carBasePremium(Profile profile, int sumInsured) {
    ...
    //this method will calculate the base premium for the car policy, depending on the clients age and mechanical breakdown status.
